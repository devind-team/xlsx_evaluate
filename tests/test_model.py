...
from xlsx_evaluate.model import Model, ModelCompiler
from xlsx_evaluate.xltypes import XLCell, XLFormula, XLRange
from xlsx_evaluate.tokenizer import f_token
from xlsx_evaluate import Evaluator

from . import testing


class ModelTest(testing.XlsxEvaluatorTestCase):
...
class ModelCompilerTest(unittest.TestCase):
    ...
    def test_dict_read_and_parse(self):
        ...
        self.assertEqual(4.0, evaluator.evaluate("Sheet1!F1"))
        with self.assertRaisesRegex(RuntimeError, "Cycle detected"):
            evaluator.evaluate("Sheet1!G2")
