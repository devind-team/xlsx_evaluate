...
def ABS(
    ...
    https://support.office.com/en-us/article/abs-function-3420200f-5628-4e8c-99da-c99d7c87713c
    """
    return abs(number)
...
def ACOSH(
    ...
    https://support.office.com/en-us/article/acosh-function-e3992cc1-103f-4e72-9f04-624b9ef5ebfe
    """
    if number < 1:
        raise xlerrors.NameExcelError(f'number {number} must be greater than or equal to 1')
...
def ASIN(
    ...
    https://support.office.com/en-us/article/asin-function-81fb95e5-6d6f-48c4-bc45-58f955c6d347
    """
    if number < -1 or number > 1:
        raise xlerrors.NumExcelError(f'number {number} must be less than  or equal to -1 or greater ot equal to 1')
...
def ASINH(
    ...
    https://support.office.com/en-us/article/asinh-function-4e00475a-067a-43cf-926a-765b0249717c
    """
...
def ATAN(
    ...
    https://support.office.com/en-us/article/atan-function-50746fa8-630a-406b-81d0-4a2aed395543
    """
...
def CEILING(
    ...
    if significance < 0 < number:
        raise xlerrors.NumExcelError('significance below zero and number above zero is not allowed')
...
def COS(
    ...
    https://support.office.com/en-us/article/cos-function-0fb808a5-95d6-4553-8148-22aebdce5f05
    """
...
def COSH(
    ...
    https://support.office.com/en-us/article/cosh-function-e460d426-c471-43e8-9540-a57ff3b70555
    """
...
def DEGREES(
    ...
    https://support.office.com/en-us/article/degrees-function-4d6ec4db-e694-4b94-ace0-1cc3f61f9ba1
    """
...
def EVEN(
    ...
    https://support.office.com/en-us/article/even-function-197b5f06-c795-4c1e-8696-3c3b8a646cf9
    algorithm found here;
        https://stackoverflow.com/questions/25361757/python-2-7-round-a-float-up-to-next-even-number
    """
    if number < 0:
...
def FACT(
    ...
    https://support.office.com/en-us/article/fact-function-ca8588c2-15f2-41c0-8e8c-c11bd471a4f3
    """
    if number < 0:
...
def LN(
    ...
    https://support.office.com/en-us/article/ln-function-81fe1ed7-dac9-4acd-ba1d-07a142c6118f
    """
...
def LOG10(
    ...
    https://support.office.com/en-us/article/log10-function-c75b881b-49dd-44fb-b6f4-37e3486a0211
    """
...
def RADIANS(
    ...
    https://support.office.com/en-us/article/radians-function-ac409508-3d48-45f5-ac02-1497c92de5bf
    """
...
def ROUNDUP(
    ...
    https://support.office.com/en-us/article/ROUNDUP-function-f8bc9b23-e795-47db-8703-db171d0c42a7
    """
...
def SIN(
    ...
    https://support.office.com/en-us/article/sin-function-cf0e3432-8b9e-483c-bc55-a76651c95602
    """
...
def SQRT(
    ...
    https://support.office.com/en-us/article/sqrt-function-654975c2-05c4-4831-9a24-2c65e4040fdf
    """
    if number < 0:
...
def SUMIFS(
    ...
    range_len = len(criteria_range.flat)
    new_range = []
    idx = 0
    for item in criteria_and_ranges:
        if idx == range_len:
...
def TAN(
    ...
    https://support.office.com/en-us/article/tan-function-08851a40-179f-4052-b789-d7f699447401
    """
